...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{face_8hpp__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
...
\begin{DoxyCompactList}\small\item\em describes a face coordinate (cartesian) \end{DoxyCompactList}\end{DoxyCompactItemize}
