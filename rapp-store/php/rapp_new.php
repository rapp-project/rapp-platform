...
<div id="layout" class="pure-g">
    ...
    <!-- Step Index: used for purely informative reasons -->
    <div class="pure-u pure-u-md-4-24">

    <?php
    
        /// NOTE: Select the basic information
        $step1_html =
        "<div class=\"rapp-new-menu-item\">
            ...
            <div class=\"pure-u-3-4\">
                ...
                CPU architecture, tags identifying the new RAPP and a thumbnail that will be displayed in the RAPP store.</p>
            </div>
        </div>";
