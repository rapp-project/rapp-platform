...
void asio_service_client::Schedule (
...
{
    if ( !socket_ )
        throw std::runtime_error ( "asio_service_client::handle_resolve socket ptr null" );
...
{
    if ( !socket_ )
        throw std::runtime_error ( "asio_service_client::handle_connect socket ptr null" );
...
{
    if ( !socket_ )
        throw std::runtime_error ( "asio_service_client::handle_write_request socket ptr null" );
...
{
    if ( !socket_ )
        throw std::runtime_error ( "asio_service_client::handle_read_status_line socket ptr null" );
...
{
    if ( !socket_ )
        throw std::runtime_error ( "asio_service_client::handle_read_headers socket ptr null" );
...
{
    if ( !socket_ )
        throw std::runtime_error ( "asio_service_client::handle_read_content socket ptr null" );
