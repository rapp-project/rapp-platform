...
/* ------------< Load parameters >-------------*/
var svcParams = ENV.SERVICES.auth_service_access;
...
function svcImpl( kwargs )
{
  ...
  var request = this;
  // this service can only be accessed from localhost
  if ( this.socket.hostname !== 'localhost' ){
    return hop.HTTPResponseString("Access denied", {
