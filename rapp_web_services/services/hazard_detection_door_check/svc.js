 ...
 * @fileOverview
 *
 * [Hazard-Detection-Door-Check] RAPP Platform front-end web service.
 *
...
const rosSrvName = "/rapp/rapp_hazard_detection/door_check";
...
function parseRosbridgeMsg(rosbridge_msg) {
  ...
  const da = rosbridge_msg.door_angle;
