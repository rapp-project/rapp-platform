...
Fs.renameFile(YAMLfile_uri, cpYAMLFilePath);
 ...
 // Fs.writeFileSync("/home/rapp/rapp_platform_files/maps/"+user_name+"/"+map_name+".png",PNGfile_uri );
 // Fs.writeFileSync("~/rapp_platform_files/maps/"+user_name+"/"+map_name+".yaml",YAMLfile_uri );
