...
/* ------------< Load parameters >-------------*/
var svcParams = ENV.SERVICES.object_recognition;
 ...
 *  @param {String} args.file - System uri path of transfered (client) file, as
 *    declared in multipart/form-data post field. The file is handled and
...
function svcImpl ( kwargs )
{
  ...
  /***
   *  For security reasons, if file is not defined under the
  ...
  {
    var errorMsg = "Service invocation error. Invalid {file} field!" +
  ...
  return hop.HTTPResponseAsync(
    function( sendResponse ) {
      ...
      rosSvcReq.objectFileUrl = cpFilePath;
